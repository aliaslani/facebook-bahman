...
class User(models.Model):
    ...
    coutry = models.CharField(max_length=20, choices=CountryChoices.choices, default=CountryChoices.IRAN , verbose_name='کشور محل سکونت')
...
class Post(models.Model):
    ...
    content = models.TextField(verbose_name='مخاطب')
    user = models.ForeignKey(User, on_delete=models.CASCADE , verbose_name='کاربر')
    created_at = models.DateTimeField(auto_now_add=True , verbose_name='زمان آپلود')
    last_upate = models.DateTimeField(auto_now=True , verbose_name='زمان ویرایش')
